...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return an {@link Earthquakes} object to represent a single earthquake.
     */
    ...
    /**
     * Return an {@link Earthquakes} object by parsing out information
    ...
    private static ArrayList<Earthquakes> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < featureArray.length(); i++) {
                ...
                earthquakes.add(new Earthquakes(magnitude, location, time, url));
            }
